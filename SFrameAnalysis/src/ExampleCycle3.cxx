...
// Local include(s):
#include "include/ExampleCycle3.h"
#include "include/BTagEffHistsTopTag.h"

ClassImp( ExampleCycle3 );

ExampleCycle3::ExampleCycle3()
   : AnalysisCycle() {
...
void ExampleCycle3::BeginCycle() throw( SError ) 
{
...
void ExampleCycle3::EndCycle() throw( SError ) 
{
...
void ExampleCycle3::BeginInputData( const SInputData& id ) throw( SError ) 
{
...
void ExampleCycle3::EndInputData( const SInputData& id ) throw( SError ) 
{
...
void ExampleCycle3::BeginInputFile( const SInputData& id ) throw( SError ) 
{
...
void ExampleCycle3::ExecuteEvent( const SInputData& id, Double_t weight) throw( SError ) 
{
